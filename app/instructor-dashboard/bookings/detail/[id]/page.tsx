...
import { bookingRequests, students } from "@/lib/data"
import {
  Clock,
  Calendar,
  User,
...
export default function BookingRequestDetailPage({ params }: { params: { id: string } }) {
  const router = useRouter()
  const booking = bookingRequests.find((req) => req.id === params.id)
  ...
  const handleConfirmTimeUpdate = () => {
    ...
    if (bookingIndex !== -1) {
      bookingRequests[bookingIndex].time = time
      bookingRequests[bookingIndex].status = "confirmed"
    }
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              >
                {booking.status === "completed" ? "完了" : booking.status === "confirmed" ? "✓ 確定" : "○ 仮予約"}
              </Badge>
            </div>
          </CardHeader>
        </Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex items-center gap-2 text-sm">
                ...
                <span>{student?.phone || booking.phone}</span>
              </div>
              <div className="flex items-center gap-2 text-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200 rounded-lg p-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-bold text-2xl text-blue-900">{booking.time || "--:--"}</span>
                </div>
              </div>
            </div>
